...
const Footer: React.FC = () => {
  const footerSections: FooterSection[] = [
    ...
    },
    {
      ...
      links: [
        { name: "About", href: "/" },
        { name: "Blog", href: "https://directly-inspired-by-cot.hashnode.dev/alteras-ai-agents-level-up-eric-schmidt-bets-on-the-future-of-game-playing-ai" },
        { name: "Careers", href: "/" },
        { name: "Press", href: "/" }
      ]
    },
    {
      ...
      links: [
        ...
        { name: "Community", href: "https://discord.com/users/1413004571017613332" },
  ...
  const socialLinks = [
    { name: "Portfolio", icon: <img src="social.png" alt="" />, href: "https://punyanshsingla.com", target: "_blank"},
    { name: "Twitter", icon: <img src="twitter.png" alt="" />, href: "https://x.com/PunyanshSi87846", target: "_blank"},
    { name: "GitHub", icon: <img src="github.png" alt="" />, href: "https://github.com/7425036696/NovaPersona", target: "_blank"},
    { name: "LinkedIn", icon:<img src="linkedin.png" alt="" />, href: "", target: "_blank"}, 
    { name: "Discord", icon:<img src="discord.png" alt="" />, href: "https://discord.gg/SsgjHTVR", target: "_blank"}
  ];
        ...
        <div className="grid lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold">NovaPersona</span>
            </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-6 mb-4 md:mb-0">
            <p className="text-gray-500">
              © 2025 NovaPersona. All rights reserved.
            </p>
          </div>
          <div className="flex items-center space-x-6 text-sm text-gray-500">
            ...
            <span>Made with ❤️ for curious minds by Punyansh Singla</span>
          </div>
        </div>
      </div>
