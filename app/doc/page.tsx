        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <p className="mb-4 text-gray-700">
              NovaPersona is an open-source AI-powered platform that enables
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <a
              href="https://github.com/7425036696/NovaPersona"
              target="_blank"
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="p-4 bg-gray-50 rounded-lg space-y-2">
              ...
              <a
                href="mailto:punyanshcoder@gmail.com"
              ...
              <div className="flex gap-4 mt-2">
                {/* X */}
                <a
                  href="https://x.com/PunyanshSi87846"
                  target="_blank"
